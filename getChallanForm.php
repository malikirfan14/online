        ...
        <!-- Sidebar -->
         ...
         <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">WMDC Dashboard <sup>2</sup></div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <form class="form-horizontal" action="" id ="rform" role="form"  target="_blank">
              ...
              <button type="button" class="btn btn-danger" style = "color : White; float : right; margin-top : 22px; margin-right : 10px">
                ...
                <h2>Challan Form <br> MBBS/ BDS program</h2>
                ...
                <div class="form-group">
                    ...
                    <label for="name" class="col-sm-3 control-label" >Application Id*</label>

                    <div class="col-sm-9">

                        <input type="text" placeholder="Application id" name="term" required >
