...
?> 
                ...
                <div class="container-fluid">
                 ...
                 <div class="container">
            <form class="form-horizontal" action="MBBSFeeChallan.php" id ="rform" role="form" style="margin-top: 50px;">
                <h2>Get MBBS Fee Voucher Here </h2>
                <br><br>
                 <div class="form-group" >
                  <div class="col-sm-9">
                        <span class="help-block">Step 1 : Enter code  </span> <br/>
                        <span class="help-block">Step 2 : Click on Submit Button </span>
                 ...
                 <br>
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label" >Enter Code Receive in Email *</label>
                    <div class="col-sm-9">
