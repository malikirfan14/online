        ...
        ?>
                                            ...
                                            <thead>
                                                ...
                                                <tr style="font-size: 20px;">
                                                   ...
                                                   ?>
                                                    ...
                                                    <th scope="col">Upload Challan</th>
          ...
          ';
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($rowf['program'] == 'MBBS') {

                                                            echo '

             <button type="button" class="btn btn-danger" style = "color : White; ">

                <a href="UMBBSChallan.php" style = "color : White; ">Upload</a>

              </button>

          ';

                                                        } else if ($rowf['program'] == 'BDS') {

                                                            echo '

                                                                    <button type="button" class="btn btn-danger" style = "color : White; ">

                                                                       <a href="UBDSChallan.php" style = "color : White; ">Upload</a>
                                                            ...
                                                            echo '
                                                                    ...
                                                                    <button type="button" class="btn btn-danger" style = "color : White; ">
                                                                       ...
                                                                       <a href="UBothChallan.php" style = "color : White; ">Upload</a>
