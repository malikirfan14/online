 ...
 <div class="col-xs-3 span12">
     <div class="table-responsive overflowtable">
         <h6 class="text-right"><strong>Bank Copy</strong></h6>
          <h5 class="sub-header text-center "><strong>Watim Dental College (Pvt) Ltd.</strong></h5>
        ...
        <table class="span12">
             <tr>
                  <td class="col-md-1"><h6 style="font-size:12px;"> <strong>Account Number:</strong></h6></td>
                   <td class="col-md-1 text-right"><h6 style="font-size:12px;"><strong>7590200003230</strong></h6></td>
                  </tr>
        </table>
        <!--<br>-->
            ...
            <table class="span12">
              ...
              <tbody>   
                ...
                <tr>
                 ...
                 <td class="col-md-3"><h6 style="font-size:12px;">BDS / 2026-27 </h6></td>
                </tr>
                <tr>
