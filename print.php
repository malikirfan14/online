...
<body>
  ...
  <div class="row">
    ...
    <div class="row mt-1">
        ...
        <div class="col col-sm-4">        
            <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label"><strong>Program</strong></label>
            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row["program"];?>" readonly>
            </div>
          </div>

        <div class="col col-sm-4">
          <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label"><strong>Aggregate</strong></label>
            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row["aggregatePer"];?>" readonly>
            </div>
         </div>        
        ...
        <div class="col col-sm-6">
          <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label"><strong>Gender</strong></label>
            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row["gender"];?>" readonly>
            </div>        
        </div>

        <div class="col col-sm-6">
            <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label"><strong>CNIC Number</strong></label>
...
<div class="row mt-1">
    ...
    <div class="col col-sm-4">
      ...
      <div class="mb-1">
        ...
        <label for="exampleInputEmail1" class="form-label"><strong>Emergency Mobile Number</strong></label>

        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row["emergencyPhone"];?>" readonly>
    ...
    <div class="row mt-1">
     ...
     <div class="col col-sm-4">
      ...
      <div class="mb-1">
        ...
        <label for="exampleInputEmail1" class="form-label"><strong>UHS Application ID</strong></label>

        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row["uhs_application_id"];?>" readonly>
     ...
     <div class="col col-sm-8">
      ...
      <div class="mb-1">
        ...
        <label for="exampleInputEmail1" class="form-label"><strong>UHS College</strong></label>

        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row["uhs_college"];?>" readonly>
    ...
    <div class="row">
        ...
        <h5 class="mb-1">
            ...
            <br />
            <br />
            <!--<u>Qualifications(Aggregate marks in HSSC / equivalent must not be less than 60% i.e. 660/1100)</u>-->

        </h5>

        

        <table class="table table-bordered mt-2 table-bordered" style =" border: 1px solid black; border-collapse: collapse; width:99%" >
...
Grade / A-Level</th>
            ...
            <tr >
              ...
              <td><?php 
                echo ($row["mcat_passing_year"] > 2024) ? "180" : "200"; 
              ?></td>
