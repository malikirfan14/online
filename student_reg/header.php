...
?>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        if ($conn === false) {
                            ...
                            if (isset($_SESSION['logname']) != "") {
                                ...
                                $query = "SELECT * FROM `registration_22to23` WHERE `cnic` = '$logname'";
                                $result = mysqli_query($conn, $query);
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        echo '<a class="collapse-item" >Successfully Applied</a>
                                ';
                                    }
                                } else {
                                    echo '<a class="collapse-item" href="AddmissionRegistration.php" >Apply Now</a>
                                    ';
                                }
                            }
                        }
           ...
           $folder1 = 'challan-MBBS-AND-BDS/'.$_SESSION['logname'];
            $folder2 = 'challanBDS/'.$_SESSION['logname'];
            $folder3 = 'challanMBBS/'.$_SESSION['logname'];
            // echo $folder;
            if (is_dir($folder1) || is_dir($folder2) || is_dir($folder3)) {
                echo '
                <a class="collapse-item" href="uploadChallan.php" style ="display: inline-block; 
  pointer-events: none;">Uploaded Successfully</a>';
            } else {
                echo '
    <a class="collapse-item" href="uploadChallan.php">Upload Challan</a>';
         ...
         -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="updateResult.php">
            ...
            $folder1 = 'upload/' . $_SESSION['logname'];
            // echo $folder;
            if (is_dir($folder1)) {
                echo '
    <li class="nav-item">
            <a class="nav-link" href="multiple.php" style ="display: inline-block; 
  pointer-events: none;" disable>
                <i class="fa fa-wrench"></i>
                <span>Uploaded Successfully</span></a>
        </li>';
            } else {
                echo '
   <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        if ($conn === false) {
                            ...
                            if (isset($_SESSION['logname']) != "") {
                                ...
                                $query = "SELECT * FROM `student_reg` WHERE `cnic` = '$logname'";
                                $result = mysqli_query($conn, $query);
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                        ?>
