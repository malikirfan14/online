...
if(isset($_SESSION['adminName'])) {
    ...
    if ($conn === false) {
        ...
        $records_per_page_v = 50; // Number of records to display per page
        $page_v = isset($_GET['page']) ? $_GET['page'] : 1; // Get the current page number
    ...
    <div class="row justify-content-center" style="margin-top: 50px;">
        <div class="col-md-6 text-center">
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-sm btn-block" name="unverifiedStudents">
                    Go to Unverified Students
                </button>
            </div>
        </div>
    </div>
...
<?php
    if (isset($_POST['unverifiedStudents'])) {
            ...
            <div class="table">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $sn = 1;
                        mysqli_data_seek($connect, 0); // Reset the result_v pointer to the beginning
                ...
                <div class="text-center"> <!-- Center align pagination links -->
                    <nav>
                        <ul class="pagination">
                            ...
                            for ($i = 1; $i <= $total_pages_v; $i++) {
                                echo "<li class='page-item'><a class='page-link' href='adminVerified.php?page=$i'>$i</a></li>";
                            }
                            ?>
                        </ul>
                    </nav>
